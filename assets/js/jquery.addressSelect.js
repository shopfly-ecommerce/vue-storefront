  ...
  addressSelect.prototype = {
    ...
    initElement: function () {
      ...
      var html = '<div class="app-address">'
        ...
        + '<div class="app-address-title-view">-- Select --</div><i style="padding: 0;"></i></div>'
        + '<div class="app-address-body">'
        + '<div class="app-address-tab">'
        + '<a href="javascript: void(0);" class="app-address-tab-a show"><em>Select</em> <i class="cur" style="padding: 0;"></i></a></div>'
