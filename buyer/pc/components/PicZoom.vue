    ...
    methods: {
      ...
      mousemove(e){
        ...
        let range = {
          ...
          minY:imgwrap.top - (document.documentElement.scrollTop || document.body.scrollTop),
          maxY:imgwrap.top - (document.documentElement.scrollTop || document.body.scrollTop) + this.imgwrap.offsetHeight - this.cover.offsetHeight
        }
        if(pos.x > range.maxX){
          pos.x = range.maxX
        }
        ...
        let startX = pos.x - (imgwrap.left - (document.documentElement.scrollLeft || document.body.scrollLeft)),
          startY = pos.y - (imgwrap.top - (document.documentElement.scrollTop || document.body.scrollTop))
